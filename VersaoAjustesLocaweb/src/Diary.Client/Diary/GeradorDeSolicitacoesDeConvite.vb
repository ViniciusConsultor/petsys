...
Public Class GeradorDeSolicitacoesDeConvite
    ...
    Private Sub EscrevaSolicitacoes()
        ...
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Data/hora do evento", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Local", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Descrição", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Observação", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Contato", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        Tabela.AddCell(iTextSharpUtilidades.CrieCelula("Data/hora do cadastro", _Fonte2, Cell.ALIGN_CENTER, 13, True))
        ...
        For Each Solicitacao As ISolicitacaoDeConvite In _Solicitacoes
            ...
            Tabela.AddCell(iTextSharpUtilidades.CrieCelula(Solicitacao.DataEHorario.ToString("dd/MM/yyyy HH:mm:ss").ToString, _Fonte1, Cell.ALIGN_CENTER, 13, False))
            Tabela.AddCell(iTextSharpUtilidades.CrieCelula(Solicitacao.Local, _Fonte1, Cell.ALIGN_LEFT, 13, False))
            Tabela.AddCell(iTextSharpUtilidades.CrieCelula(Solicitacao.Descricao, _Fonte1, Cell.ALIGN_LEFT, 13, False))
            Tabela.AddCell(iTextSharpUtilidades.CrieCelula(Solicitacao.Observacao, _Fonte1, Cell.ALIGN_LEFT, 13, False))

...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <telerik:RadDockLayout ID="RadDockLayout1" runat="server" Skin="Vista">
        <telerik:RadDockZone ID="RadDockZone1" runat="server" Skin="Vista">
            <telerik:RadDock ID="RadDock1" runat="server" Title="Agências bancárias" DefaultCommands="ExpandCollapse"
                ...
                <ContentTemplate>
                    ...
                    <table class="tabela" runat="server" id="pnlaAgencia">
                        <tr>
                            <td class="th3">
                                <asp:Label ID="Label1" runat="server" Text="Agência"></asp:Label>
                            </td>
                            <td class="td">
                                <telerik:RadComboBox ID="cboAgencia" runat="server" EmptyMessage="Selecione uma agência"
                                    EnableLoadOnDemand="True" LoadingMessage="Carregando..." MarkFirstMatch="false"
                                    ShowDropDownOnTextboxClick="False" AllowCustomText="True" HighlightTemplatedItems="True"
                                    Width="90%" Skin="Vista" CausesValidation="False" AutoPostBack="True">
                                    <HeaderTemplate>

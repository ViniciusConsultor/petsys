...
{
    [Serializable]
    public class FiltroBoletosGeradosPorIntervaloDeDataDeVencimento : Filtro, IFiltroBoletosGeradosPorIntervaloDeDataDeVencimento
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.Append(" WHERE " + ObtenhaFiltroMontado("FN_BOLETOS_GERADOS.DATAVENCIMENTO", false));

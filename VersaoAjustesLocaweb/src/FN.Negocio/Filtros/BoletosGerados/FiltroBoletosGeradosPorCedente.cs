...
{
    [Serializable]
    public class FiltroBoletosGeradosPorCedente : Filtro, IFiltroBoletosGeradosPorCedente
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.Append(" WHERE " + ObtenhaFiltroMontado("FN_BOLETOS_GERADOS.IDCEDENTE", false));

...
Public Class MapeadorDePessoaJuridica
    ...
    Private Function ObtenhaQueryBasica() As String
        ...
        Sql.Append("SELECT NCL_PESSOA.NOME NOMEPESSOA, TIPO, NCL_PESSOAJURIDICA.IDPESSOA, ")
        Sql.Append("NOMEFANTASIA, CNPJ, IE, IM, SITE, NCL_PESSOA.IDBANCO, IDAGENCIA, CNTACORRENTE, TIPOCNTACORRENTE, NCL_AGENCIABANCO.NUMERO  NUMEROAGENCIA, NCL_AGENCIABANCO.NOME  NOMEDAAGENCIA, LOGOMARCA ")
        Sql.Append("FROM NCL_PESSOA ")
        Sql.Append("INNER JOIN NCL_PESSOAJURIDICA ON ID = NCL_PESSOAJURIDICA.IDPESSOA ")
        Sql.Append("LEFT JOIN NCL_AGENCIABANCO ON  NCL_AGENCIABANCO.IDBANCO =  NCL_PESSOA.IDBANCO AND NCL_AGENCIABANCO.ID = NCL_PESSOA.IDAGENCIA ")

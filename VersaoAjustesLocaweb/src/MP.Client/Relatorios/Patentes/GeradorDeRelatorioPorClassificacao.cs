...
{
    public class GeradorDeRelatorioPorClassificacao
    {
        ...
        public GeradorDeRelatorioPorClassificacao(IDictionary<long, IList<IRevistaDePatente>> dicionarioDePatentesDeColidentes, IList<IRadicalPatente> radicais)
        {
        ...
        private string GereInformacoesUteisParaOArquivoDeSaidaDoRelatorio()
        {
            ...
            escritor.PageEvent = new GeradorDeRelatorioPorClassificacao.Ouvinte(_Fonte1, _Fonte2, _Fonte3, _Fonte4, empresa, _NumeroDaRevistaSelecionada, _DataPublicacao);
        ...
        private void MonteDocumentoDoRelatorio()
        {
            ...
            {
                if(string.IsNullOrEmpty(radical.Classificacao))
                    continue;

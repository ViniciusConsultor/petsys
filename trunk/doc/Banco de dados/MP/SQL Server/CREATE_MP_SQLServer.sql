...
(
	IDTITULARINVENTOR				BIGINT				NOT NULL,
	IDPATENTE						BIGINT				NOT NULL
);
...
ALTER TABLE MP_REVISTA_MARCAS
	ADD CONSTRAINT FK_MP_REVISTA_MARCAS_PROCESO
	FOREIGN KEY(IDPROCESSO)
	REFERENCES MP_PROCESSOMARCA(IDPROCESSO)

ALTER TABLE MP_REVISTA_MARCAS
	ADD CONSTRAINT FK_MP_REVISTA_MARCAS_DESPACHO
	FOREIGN KEY(IDDESPACHO)
	REFERENCES MP_DESPACHO_MARCA(IDDESPACHO);
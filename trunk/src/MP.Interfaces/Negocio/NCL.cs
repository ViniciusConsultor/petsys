...
namespace MP.Interfaces.Negocio
{
    ...
    public class NCL
    {
        ...
        public static NCL NCL1 = new NCL("01", "Substâncias químicas destinadas à indústria, às ciências, à fotografia, assim como à agricultura, à horticultura e à silvicultura; resinas artificiais não-processadas, matérias plásticas não processadas; adubo; composições extintoras de fogo; preparações para temperar e soldar; substâncias químicas destinadas a conservar alimentos; substâncias tanantes; substâncias adesivas destinados à indústria.", NaturezaDeMarca.DeProduto);
        public static NCL NCL2 = new NCL("02", "Tintas, vernizes, lacas; preservativos contra oxidação e contra deterioração da madeira; matérias tintoriais; mordentes; resinas naturais em estado bruto; metais em folhas e em pó para pintores, decoradores, impressores e artistas.", NaturezaDeMarca.DeProduto);
        public static NCL NCL3 = new NCL("03", "Preparações para branquear e outras substâncias para uso em lavanderia; produtos para limpar, polir e decapar; produtos abrasivos; sabões; perfumaria, óleos essenciais, cosméticos, loções para os cabelos; dentifrícios.", NaturezaDeMarca.DeProduto);
        public static NCL NCL4 = new NCL("04", "Graxas e óleos industriais; lubrificantes; produtos para absorver, molhar e ligar pó; combustíveis (incluindo gasolina para motores) e materiais para iluminação; velas e pavios para iluminação.", NaturezaDeMarca.DeProduto);
        public static NCL NCL5 = new NCL("05", "Preparações farmacêuticas e veterinárias; preparações higiênicas para uso medicinal; substâncias dietéticas adaptadas para uso medicinal, alimentos para bebês; emplastros, materiais para curativos; material para obturações dentárias, cera dentária; desinfetantes; preparações para destruição de vermes; fungicidas, herbicidas.", NaturezaDeMarca.DeProduto);
        public static NCL NCL6 = new NCL("06", "Metais comuns e suas ligas; materiais de metal para construção; construções transportáveis de metal; materiais de metal para vias férreas; cabos e fios de metal comum não elétricos; serralharia, pequenos artigos de ferragem; canos e tubos de metal; cofres; produtos de metal comum não incluídos em outras classes; minérios.", NaturezaDeMarca.DeProduto);
        public static NCL NCL7 = new NCL("07", "Máquinas e ferramentas mecânicas; motores (exceto para veículos terrestres); e engates de máquinas e componentes de transmissão (exceto para veículos terrestres); instrumentos agrícolas não manuais; chocadeiras.", NaturezaDeMarca.DeProduto);
        public static NCL NCL8 = new NCL("08", "Ferramentas e instrumentos manuais (propulsão muscular); cutelaria; armas brancas; aparelhos de barbear.", NaturezaDeMarca.DeProduto);
        public static NCL NCL9 = new NCL("09", "Aparelhos e instrumentos científicos, náuticos, geodésicos, fotográficos, cinematográficos, ópticos, de pesagem, de medição, de sinalização, de controle (inspeção), de salvamento e de ensino; aparelhos e instrumentos para conduzir, interromper, transformar, acumular, regular ou controlar eletricidade; aparelhos para registrar, transmitir ou reproduzir som ou imagens; suporte de registro magnético, discos acústicos; máquinas distribuidoras automáticas e mecanismos para aparelhos operados com moedas; caixas registradoras, máquinas de calcular, equipamento de processamento de dados e computadores; aparelhos extintores de incêndio.", NaturezaDeMarca.DeProduto);
        ...
        private NCL(string codigo, string descricao, NaturezaDeMarca natureza)
        {
            Codigo = codigo;
            Descricao = descricao;
        ...
        public static NCL ObtenhaPorCodigo(string codigo)
        {

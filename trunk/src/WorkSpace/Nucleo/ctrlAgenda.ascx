    ...
    <telerik:RadDockZone ID="RadDockZone1" runat="server" Skin="Vista">
        <telerik:RadDock ID="RadDock1" runat="server" Title="Compromissos" DefaultCommands="ExpandCollapse"
            ...
            <ContentTemplate>
                ...
                <telerik:RadScheduler runat="server" DisplayDeleteConfirmation="false" ID="schCompromissos"
                    DataKeyField="ID" DataDescriptionField="Descricao" DataSubjectField="Assunto"
                    DataStartField="Inicio" DataEndField="Fim" AllowEdit="False" AllowInsert="False"
                    Culture="Portuguese (Brazil)" EditFormTimeFormat="hh:mm" EnableAdvancedForm="False"
                    FirstDayOfWeek="Monday" LastDayOfWeek="Friday" ShowFullTime="True" Width="100%"
                    EnableDescriptionField="True" HoursPanelTimeFormat="HH:mm" StartEditingInAdvancedForm="False" OnClientAppointmentDoubleClick="onAppointmentDoubleClick">
                    <Localization AdvancedAllDayEvent="Todo dia" AdvancedCalendarCancel="Cancelar" AdvancedClose="Fechar"
                        AdvancedDay="Dia" AdvancedDays="dia(s)" AdvancedDescription="Descrição" />

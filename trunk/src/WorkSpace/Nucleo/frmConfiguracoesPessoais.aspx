                        ...
                        <telerik:RadPageView ID="rpvAtalhos" runat="server">
                            <telerik:RadDockLayout ID="RadDockLayout2" runat="server" Skin="Vista">
                                <telerik:RadDockZone ID="RadDockZone2" runat="server" Skin="Vista">
                                    <telerik:RadDock ID="RadDock3" runat="server" Title="Atalhos de funcionalidades do sistema"
                                    ...
                                    <telerik:RadDock ID="RadDock4" runat="server" Title="Atalhos externos" DefaultCommands="ExpandCollapse"
                                        EnableAnimation="True" Skin="Vista" DockMode="Docked">
                                        <ContentTemplate>
                                            <table class="tabela">
                                                <tr>
                        ...
                        <telerik:RadPageView ID="rpvAgenda" runat="server">
                            <telerik:RadDockLayout ID="RadDockLayout3" runat="server" Skin="Vista">
                                <telerik:RadDockZone ID="RadDockZone3" runat="server" Skin="Vista">
                                    <telerik:RadDock ID="RadDock5" runat="server" Title="Dados da agenda" DefaultCommands="ExpandCollapse"
                                        EnableAnimation="True" Skin="Vista" DockMode="Docked">
                                        <ContentTemplate>
                                            <table class="tabela">
                                                <tr>

...
Public Class MapeadorDeMenu
    ...
    Public Function ObtenhaMenu() As IMenuComposto Implements IMapeadorDeMenu.ObtenhaMenu
        ...
        SQL.AppendLine("NCL_MENUFUNCAO.IDFUNCAO AS ID_FUNCAO, NCL_FUNCAO.NOME AS NOME_FUNCAO, NCL_MENUFUNCAO.IMAGEM AS IMAGEM_FUNCAO, NCL_MENUFUNCAO.URL ")
        ...
        SQL.AppendLine(" ORDER BY NCL_MENUMODULO.IDMODULO, NCL_MENUFUNCAO.IDFUNCAO")

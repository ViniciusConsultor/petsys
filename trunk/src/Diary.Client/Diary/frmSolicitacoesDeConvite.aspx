<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WorkSpace.Master" CodeBehind="frmSolicitacoesDeConvite.aspx.vb" Inherits="Diary.Client.frmSolicitacoesDeConvite" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <telerik:RadDockLayout ID="RadDockLayout1" runat="server" Skin="Vista">
        <telerik:RadDockZone ID="RadDockZone1" runat="server" Skin="Vista">
            ...
            <telerik:RadDock ID="rdkLancamentos" runat="server" Title="Solicitações de convites ativas" DefaultCommands="ExpandCollapse"
                EnableAnimation="True" Skin="Vista" DockMode="Docked">
                <ContentTemplate>
                                    ...
                                    <MasterTableView GridLines="Both">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Codigo" HeaderText="Código" 
                                             ...
                                             <telerik:GridBoundColumn DataField="DataEHorario" HeaderText="Data e hora" 
                                                UniqueName="column33">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Local" HeaderText="Local" 
                                                UniqueName="column3">
                                            </telerik:GridBoundColumn>

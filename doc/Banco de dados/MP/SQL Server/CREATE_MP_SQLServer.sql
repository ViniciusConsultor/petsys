...
CREATE INDEX IDX_MP_PATENTE2
	ON MP_PATENTE(IDNATUREZAPATENTE);
;
...
CREATE INDEX IDX_MP_MARCAS5
	ON MP_MARCAS(IDCLIENTE)
;

CREATE INDEX IDX_MP_MARCAS6
	ON MP_MARCAS(IDMARCA, PAGAMANUTENCAO,DATAPROXIMAMANUTENCAO)
;
...
CREATE INDEX IDX_MP_PROCESSOMARCA5
	ON MP_PROCESSOMARCA(DATACONCESSAO)
;
...
CREATE INDEX IDX_MP_PROCESSOPATENTE1
	ON MP_PROCESSOPATENTE(PROCESSO)
;
...
(
	...
	CODIGODESPACHO			VARCHAR(20)		NULL,
...
CREATE INDEX IDX_MP_REVISTA_MARCAS1
	ON MP_REVISTA_MARCAS(PROCESSADA, NUMEROREVISTAMARCAS)
;
...
(
	...
	DADOSPEDIDOPATENTE		VARCHAR(1000)	NULL,
	DADOSPATENTEORIGINAL	VARCHAR(1000)	NULL,
	...
	PAISESDESIGNADOS        VARCHAR(1000)	NULL,
	DATAINICIOFASENAC		VARCHAR(20)		NULL,
	DADOSDEPOSINTER         VARCHAR(1000)	NULL,
	DADOSPUBLICINTER        VARCHAR(1000)	NULL,
	...
	DECISAO					VARCHAR(1000)	NULL,
	RECORRENTE				VARCHAR(1000)	NULL,
	NUMERODOPROCESSO        BIGINT			NULL,
	CEDENTE					VARCHAR(1000)	NULL,
	CESSIONARIA				VARCHAR(1000)	NULL,	
	OBSERVACAO				VARCHAR(4000)	NULL,	
	ULTIMAINFORMACAO		VARCHAR(1000)	NULL,	
	CERTIFAVERBACAO			VARCHAR(1000)	NULL,	
	...
	CAMPOAPLICACAO			VARCHAR(1000)	NULL,	
...
CREATE INDEX IDX_MP_MP_REVISTA_PATENTE1
	ON MP_REVISTA_PATENTE(PROCESSADA, NUMEROREVISTAPATENTE)
;

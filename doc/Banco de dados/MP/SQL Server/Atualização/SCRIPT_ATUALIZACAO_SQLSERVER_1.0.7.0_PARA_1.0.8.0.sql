...
ALTER TABLE NCL_CEDENTE ADD NUMEROAGENCIA VARCHAR(10);
ALTER TABLE NCL_CEDENTE ADD NUMEROCONTA VARCHAR(20);
ALTER TABLE NCL_CEDENTE ADD TIPOCONTA INT;
ALTER TABLE NCL_CEDENTE ADD PADRAO CHAR(1);
ALTER TABLE NCL_CEDENTE ADD NUMERODOBANCO varchar(10)

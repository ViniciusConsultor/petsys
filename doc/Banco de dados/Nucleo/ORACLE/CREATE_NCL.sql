...
CREATE TABLE NCL_CFGAGENDA (
	...
	PRIMEIRODIASEMANA	SMALLINT		NOT NULL,
	HORARIOINICIO		SMALLINT		NOT NULL,
	HORARIOFIM			SMALLINT		NOT NULL,
	INTERVALO			SMALLINT		NOT NULL
);

ALTER TABLE NCL_CFGAGENDA
	ADD CONSTRAINT PK_NCL_CFGAGENDA
	PRIMARY KEY (ID)
;

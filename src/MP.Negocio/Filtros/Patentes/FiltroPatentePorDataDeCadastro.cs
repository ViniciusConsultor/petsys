...
{
    [Serializable]
    public class FiltroPatentePorDataDeCadastro : Filtro, IFiltroPatentePorDataDeCadastro
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.AppendLine(" WHERE " + ObtenhaFiltroMontado("MP_PROCESSOPATENTE.DATADECADASTRO", false));

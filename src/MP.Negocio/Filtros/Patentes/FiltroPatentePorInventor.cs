...
namespace MP.Negocio.Filtros.Patentes
{
    ...
    public class FiltroPatentePorInventor : Filtro, IFiltroPatentePorInventor
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.AppendLine(" LEFT JOIN MP_PATENTETITULARINVENTOR ON MP_PATENTETITULARINVENTOR.IDPATENTE = MP_PATENTE.IDPATENTE");
            sql.AppendLine(" INNER JOIN MP_INVENTOR ON MP_INVENTOR.IDPESSOA = MP_PATENTETITULARINVENTOR.IDTITULARINVENTOR");
            sql.AppendLine(" AND " + ObtenhaFiltroMontado("MP_PATENTETITULARINVENTOR.IDTITULARINVENTOR", false));

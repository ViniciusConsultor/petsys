...
{
    [Serializable]
    public class FiltroTipoLacamentoFinanceiroRecebimento : Filtro, IFiltroTipoLacamentoFinanceiroRecebimento
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.Append(" WHERE " + ObtenhaFiltroMontado("FN_ITEMFINANREC.TIPOLANCAMENTO", false));

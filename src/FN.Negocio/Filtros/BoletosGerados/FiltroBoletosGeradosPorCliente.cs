...
{
    [Serializable]
    public class FiltroBoletosGeradosPorCliente : Filtro, IFiltroBoletosGeradosPorCliente
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.Append(" WHERE " + ObtenhaFiltroMontado("FN_BOLETOS_GERADOS.IDCLIENTE", false));

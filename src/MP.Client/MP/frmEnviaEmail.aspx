                    ...
                    <asp:Panel ID="pnlDadosDoEmail" runat="server">
                        ...
                        <table class="tabela">
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtDestinarioManual" runat="server" Width="450px">
                                    </telerik:RadTextBox>
                                    <telerik:RadButton ID="btnAdicionarDestinatario" runat="server" Text="Adicionar"
                                        Skin="Vista" OnClick="btnAdicionarDestinatario_OnClick">
                                    </telerik:RadButton>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadGrid ID="grdDestinatarios" runat="server" AutoGenerateColumns="False"
                                        AllowPaging="True" PageSize="10" GridLines="None" Width="98%" OnItemCommand="grdDestinatarios_OnItemCommand"
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtEmailManualCC" runat="server" Width="450px">
                                    </telerik:RadTextBox>
                                    <telerik:RadButton ID="btnAdicionarDestinarioCC" runat="server" Text="Adicionar"
                                        Skin="Vista" OnClick="btnAdicionarDestinarioCC_OnClick">
                                    </telerik:RadButton>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadGrid ID="grdDestinariosCC" runat="server" AutoGenerateColumns="False"
                                        AllowPaging="True" PageSize="10" GridLines="None" Width="98%" OnItemCommand="grdDestinatariosCC_OnItemCommand"
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtDestinarioCCoManual" runat="server" Width="450px">
                                    </telerik:RadTextBox>
                                    <telerik:RadButton ID="btnAdicionarDestinarioCCo" runat="server" Text="Adicionar"
                                        Skin="Vista" OnClick="btnAdicionarDestinarioCCo_OnClick">
                                    </telerik:RadButton>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadGrid ID="grdDestinatariosCCo" runat="server" AutoGenerateColumns="False"
                                        AllowPaging="True" PageSize="10" GridLines="None" Width="98%" OnItemCommand="grdDestinatariosCCo_OnItemCommand"
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadGrid ID="grdAnexos" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                        PageSize="10" GridLines="None" Width="98%" OnItemCommand="grdAnexos_OnItemCommand"

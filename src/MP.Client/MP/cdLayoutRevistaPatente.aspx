<%@ Page Title="" Language="C#" MasterPageFile="~/WorkSpace.Master" AutoEventWireup="true"
    CodeBehind="cdLayoutRevistaPatente.aspx.cs" Inherits="MP.Client.MP.cdLayoutRevistaPatente" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="ctrlLayoutRevistaPatente.ascx" TagName="ctrlLayoutRevistaPatente"
    TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadDockLayout ID="RadDockLayout1" runat="server" Skin="Vista">
        <telerik:RadDockZone ID="RadDockZone1" runat="server" Skin="Vista">
            <telerik:RadDock ID="RadDock1" runat="server" Title="Cadastro Layout Revista Patente"
                    ...
                    <asp:Panel ID="PanelDadosDoLayout" runat="server">
                        <table class="tabela">
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtNomeDoCampo" MaxLength="50" runat="server" Width="80%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtDescricaoResumida" MaxLength="50" runat="server" Width="80%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td">
                                    <telerik:RadTextBox ID="txtDescricaoDoCampo" MaxLength="120" Width="80%" runat="server">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>

...
namespace MP.Mapeadores
{
    public class MapeadorDeMarcas : IMapeadorDeMarcas
    {
        ...
        private StringBuilder retornaSQLSelecionaTodos()
        {
            ...
            sql.Append("PAGAMANUTENCAO PagaManutencao, PERIODO Periodo, FORMADECOBRANCA FormaDeCobranca, VALORDECOBRANCA ValorDeCobranca, MES Mes ");
        ...
        public void Inserir(IMarcas marca)
        {
            ...
            sql.Append("PAGAMANUTENCAO, PERIODO, FORMADECOBRANCA, VALORDECOBRANCA, MES) ");
            sql.Append("VALUES (");
        ...
        private void InserirRadicalMarcas(IMarcas marca)
        {
            foreach (var radical in marca.RadicalMarcas)
            {
                ...
                sql.Append(String.Concat("'", UtilidadesDeString.RemoveAcentos(UtilidadesDePersistencia.FiltraApostrofe(radical.DescricaoRadical)), "', "));

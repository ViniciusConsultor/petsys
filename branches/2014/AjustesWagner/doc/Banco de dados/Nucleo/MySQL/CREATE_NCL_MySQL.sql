...
CREATE TABLE NCL_CNFGERAL (
	...
	NOMEREMETENTE			VARCHAR(255)		NULL,
...
CREATE TABLE NCL_HISTORICOEMAILANEXO (
	...
	INDICE				INT				NOT NULL,
	BINARIOANEXO		LONGBLOB		NOT NULL
);	

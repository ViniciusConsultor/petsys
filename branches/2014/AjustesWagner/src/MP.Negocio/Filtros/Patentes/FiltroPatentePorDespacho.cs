// -----------------------------------------------------------------------
// <copyright file="FiltroPatentePorDespacho.cs" company="Microsoft">
...
namespace MP.Negocio.Filtros.Patentes
{
    ...
    /// </summary>
    [Serializable]
    public class FiltroPatentePorDespacho : Filtro, IFiltroPatentePorDespacho
    {
        public override string ObtenhaQuery()
        {
            ...
            sql.AppendLine(" WHERE " + ObtenhaFiltroMontado("MP_PROCESSOPATENTE.IDDESPACHO", false));

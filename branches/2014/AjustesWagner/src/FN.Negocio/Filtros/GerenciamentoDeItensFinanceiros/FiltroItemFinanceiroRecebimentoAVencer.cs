// -----------------------------------------------------------------------
// <copyright file="FiltroItemFinanceiroRecebimentoAVencer.cs" company="Microsoft">
...
namespace FN.Negocio.Filtros.GerenciamentoDeItensFinanceiros
{
    ...
    /// </summary>
    [Serializable]
    public class FiltroItemFinanceiroRecebimentoAVencer : Filtro, IFiltroItemFinanceiroRecebimentoAVencer
    {

<%@ Page Title="" Language="C#" MasterPageFile="~/WorkSpace.Master" AutoEventWireup="true"
    CodeBehind="cdContaAReceber.aspx.cs" Inherits="FN.Client.FN.cdContaAReceber" %>
                ...
                <ContentTemplate>
                    <asp:Panel ID="pnlDadosDaConta" runat="server">
                        <table class="tabela">
                            ...
                            <tr>
                                <td class="th3">
                                    <asp:Label ID="Label3" runat="server" Text="Data do recebimento"></asp:Label>
                                </td>
                                <td class="td">
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <uc2:ctrlSituacao ID="ctrlSituacao" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td class="th3">

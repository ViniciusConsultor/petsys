...
Partial Public Class cdSolicitacaoDeVisita
    Inherits System.Web.UI.Page

    Private Const CHAVE_ESTADO As String = "CHAVE_ESTADO_CD_SOLICITACAO_VISITA"
    Private Const CHAVE_ID As String = "CHAVE_ID_SOLICITACAO_DE_VISITA"
    Private Const CHAVE_DATA As String = "CHAVE_DATA_SOLICITACAO_DE_VISITA"
    Private Const CHAVE_STATUS As String = "CHAVE_STATUS_SOLICITACAO_DE_VISITA"
    Private Const CHAVE_USUARIO_CADASTROU As String = "CHAVE_USUARIO_CADASTROU_SOLICITACAO_DE_VISITA"
    ...
    Private Sub ExibaTelaDetalhes(ByVal Id As Long)
        ...
        Using Servico As IServicoDeSolicitacaoDeVisita = FabricaGenerica.GetInstancia.CrieObjeto(Of IServicoDeSolicitacaoDeVisita)()
            Solicitacao = Servico.ObtenhaSolicitacaoDeVisita(Id)
        End Using
        ...
        Try
            Using Servico As IServicoDeSolicitacaoDeVisita = FabricaGenerica.GetInstancia.CrieObjeto(Of IServicoDeSolicitacaoDeVisita)()
                If CByte(ViewState(CHAVE_ESTADO)) = Estado.Novo Then
                    ...
                    Mensagem = "Solicitação de visita cadastrada com sucesso."
                Else
                    Servico.Modificar(Solicitacao)
                    Mensagem = "Solicitação de visita modificada com sucesso."
                End If
    ...
    Private Function MontaObjeto() As ISolicitacaoDeVisita
        Dim Solicitacao As ISolicitacaoDeVisita
        Dim Contato As IContato
        Dim DataDaSolicitacao As Date

        Solicitacao = FabricaGenerica.GetInstancia.CrieObjeto(Of ISolicitacaoDeVisita)()
    ...
    Private Function ValidaLancamento() As String
        ...
        If String.IsNullOrEmpty(txtAssunto.Text) Then Return "O assunto da solicitação de visita deve ser informado."
        If String.IsNullOrEmpty(txtDescricao.Text) Then Return "A descrição da solicitação de visita deve ser informada."
        Return Nothing
    End Function

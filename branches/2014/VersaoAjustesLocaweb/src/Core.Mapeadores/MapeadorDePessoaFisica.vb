...
Public Class MapeadorDePessoaFisica
    ...
    Private Function ObtenhaQueryBasica() As String
        ...
        Sql.Append("UFEXP, CPF, NATURALIDADE, FOTO, SITE, NCL_PESSOA.IDBANCO, IDAGENCIA, CNTACORRENTE, TIPOCNTACORRENTE, NCL_AGENCIABANCO.NUMERO  NUMEROAGENCIA, NCL_AGENCIABANCO.NOME NOMEDAAGENCIA ")

    ...
    public class EspecieDocumento_Caixa : AbstractEspecieDocumento, IEspecieDocumento
    {
        ...
        public string getCodigoEspecieByEnum(EnumEspecieDocumento_Caixa especie)
        {
            switch (especie)
            {
                ...
                case EnumEspecieDocumento_Caixa.Recibo: return "7";
        ...
        public EnumEspecieDocumento_Caixa getEnumEspecieByCodigo(string codigo)
        {
            switch (codigo)
            {
                ...
                case "7": return EnumEspecieDocumento_Caixa.Recibo;
            ...
            try
            {
                ...
                switch (getEnumEspecieByCodigo(idCodigo))
                {
                    ...
                    case EnumEspecieDocumento_Caixa.Recibo:
                        this.Codigo = getCodigoEspecieByEnum(EnumEspecieDocumento_Caixa.Recibo);
                        this.Especie = "Recibo";
                        this.Sigla = "RC";
                        break;

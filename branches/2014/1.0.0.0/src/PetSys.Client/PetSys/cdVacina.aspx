<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WorkSpace.Master"
    CodeBehind="cdVacina.aspx.vb" Inherits="PetSys.Client.cdVacina" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <telerik:RadDockLayout ID="RadDockLayout1" runat="server" Skin="Vista">
        <telerik:RadDockZone ID="RadDockZone1" runat="server" Skin="Vista">
            <telerik:RadDock ID="pnlDadosDaVacina" runat="server" Title="Dados da vacina" DefaultCommands="ExpandCollapse"
                EnableAnimation="True" Skin="Vista" DockMode="Docked">
                <ContentTemplate>
                    <table class="tabela">
                        <tr>
                            <td class="th3">
                                <asp:Label ID="Label1" runat="server" Text="Data da vacinação"></asp:Label>
                            </td>
                            <td class="td">
                        ...
                        <tr>
                            <td class="th3">
                                <asp:Label ID="Label4" runat="server" Text="Revacinar em"></asp:Label>
                            </td>
                            <td class="td">

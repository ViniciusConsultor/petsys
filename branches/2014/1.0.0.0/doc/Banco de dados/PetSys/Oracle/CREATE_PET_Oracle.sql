...
CREATE TABLE PET_ANIMAL (
	...
	IDPROPRIETARIO		NUMBER(11)		NOT NULL,
...
CREATE TABLE PET_VACINA (
	ID					NUMBER(11)		NOT NULL,
	IDANIMAL			NUMBER(11)		NOT NULL,
	NOME				VARCHAR2(50)	NOT NULL,
	DATA				NUMBER(9)		NOT NULL,
	OBSERVACAO			VARCHAR2(4000)		NULL,
	REVACINAREM			NUMBER(9)			NULL,
	IDVETERINARIORESP	NUMBER(11)		NOT NULL,
)
...
CREATE TABLE PET_ATENDANIMAL (
	ID					NUMBER(11)		NOT NULL,
	IDANIMAL			NUMBER(11)		NOT NULL,
	IDVETERINARIO		NUMBER(11)		NOT NULL,
	DATAEHORA			VARCHAR2(20)	NOT NULL,
	DATAEHORARETORNO	VARCHAR2(20)		NULL,
	QUEIXA				VARCHAR2(4000)		NULL,
	SINCLINICO			VARCHAR2(4000)		NULL,
	PROGNOSTICO			VARCHAR2(4000)		NULL,
	TRATAMENTO			VARCHAR2(4000)		NULL,
...
CREATE TABLE PET_ATENDVAC (
	IDATENDIMENTO		NUMBER(11)	NOT NULL,
	IDVACINA			NUMBER(11)	NOT NULL
);
...
CREATE TABLE PET_ATENDVERM (
	IDATENDIMENTO		NUMBER(11)	NOT NULL,
	IDVERMIFUGO			NUMBER(11)	NOT NULL
);

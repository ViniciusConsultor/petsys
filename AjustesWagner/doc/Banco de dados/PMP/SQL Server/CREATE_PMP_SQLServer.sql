...
CREATE TABLE PMP_PROCESSOSPATENTEEVISTA (
	ID							VARCHAR(255)	NOT NULL,
	NUMERODAREVISTA				VARCHAR(30)		NOT NULL,
	DATAPUBLICACAOREVISTA		INTEGER			NOT NULL,
	NUMEROPROCESSODEPATENTE		VARCHAR(50)		NOT NULL,
	DATADODEPOSITO				INTEGER				NULL,
	CLASSIFICACAO				VARCHAR(255)		NULL,
	TITULO						VARCHAR(4000)		NULL,
	RESUMO						VARCHAR(4000)		NULL,
	NUMERODEPOSITOPCT			VARCHAR(255)		NULL,
	DEPOSITANTES				VARCHAR(1000)		NULL,
	INVENTORES					VARCHAR(1000)		NULL,
	NUMEROPRIORIDADE			VARCHAR(255)		NULL,
	DATAPRIORIDADE				INTEGER				NULL,
	PAISPRIORIDADE				CHAR(2)				NULL
)

ALTER TABLE PMP_PROCESSOSPATENTEEVISTA
	ADD CONSTRAINT PK_PMP_PROCESSOSPATENTEEVISTA
	PRIMARY KEY (ID);	
